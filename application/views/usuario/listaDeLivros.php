...
<body>
	...
	<div class="container">
		<div class="row">
			<h1>Reserve um dos nossos livros</h1>
            <br/>
			<a class="btn btn-success margin-button15" href="<?php echo base_url('usuarios/alterar'); ?>">Alterar cadastro</a>
			<a class="btn btn-success margin-button15" href="<?php echo base_url('Multas/recuperar/'.$this->session->userdata('usuario'));?>">Minhas Multas</a>
					...
					foreach ($livros as $livro) {
						echo '<tr>';
							...
							echo '<td class="text-center">';
								echo '<a  href="/emprestimos/reservar/'. $livro->id.'"title=Editar cadastro" class=btn btn-primary btn-block">Reservar</a>';
							echo '</td>';
						echo '</tr>';
						$contador++;
					}
